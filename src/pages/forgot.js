...
function Forgot() {
    ...
    function HandleClick(event){
        event.preventDefault()
            axios.post("https://thepc.herokuapp.com/api/reset/", qs.stringify({email}), {
                headers: {
                                ...
                                <div className="row">
                                    <div className="col-md-9 col-lg-8 mx-auto">
                                        <div>
                                            ...
                                            <button className="btn btn-lg btn-dark btn-block btn-login btn-blue text-uppercase font-weight-bold mb-2" onClick={HandleClick}>Send Password Reset Link</button>
                                ...
                                <div className="row">
                                    <div className="col-md-9 col-lg-8 mx-auto">
                                        <div>
                                            <center>
                                                <h1> <Icon.LockFill className="mb-2 display-3" /></h1>
                                                <h1 className="login-heading mb-4">Check your email for the password reset link.</h1></center>    
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="row">
                                    <div className="col-md-9 col-lg-8 mx-auto">
                                        <div>
                                            <center>
                                                <h1> <Icon.LockFill className="mb-2 display-3" /></h1>
                                                <h1 className="login-heading mb-4">{err}</h1></center>   
                                        </div>
                                    </div>
                                </div>
                            </div>
